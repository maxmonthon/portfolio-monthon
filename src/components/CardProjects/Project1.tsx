      ...
      <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden">
        ...
        <div className="px-0 md:px-10">
          ...
          <div className="flex space-x-2 my-2">
            ...
            <img
              className="h-10 w-10 rounded-full"
              src="https://image.pngaaa.com/770/3801770-middle.png"
              alt=""
            />
            <img
              className="h-10 w-10 rounded-full"
          ...
          <p className="uppercase py-5 text-gray-300  ">
            A Shopping website where the user can select the product make a
            quantity add it to the cart and delete it from the cart.
            &nbsp;&nbsp;
          ...
          <ul className="list-disc space-y-5 ml-5 text-lg">
            ...
            />
            <SocialIcon
              url="https://github.com/monthonkachana/FakeShop-E-Commercer-MERN"
              fgColor="gray"
              bgColor="transparent"
            />
            <SocialIcon
              url="https://drive.google.com/drive/folders/14nqFohBsB0gb_oadOjdFLQnQvZqZEsK8"
              fgColor="gray"
              bgColor="transparent"
            />
          </ul>

    ...
    <div>
      <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden">
        <motion.img
          ...
          viewport={{ once: true }}
          src="https://user-images.githubusercontent.com/116298646/197016704-1a174e55-b52d-4b64-8970-84f043a3671a.png"
        ...
        <div className="px-0 md:px-10">
          <h4 className="text-4xl font-light">Clone-instagram</h4>
          ...
          <p className="uppercase py-5 text-gray-300">
            This project is a simplified front end clone of instagram. It was
          ...
          <ul className="list-disc space-y-5 ml-5 text-lg">
            <li>WORKSHOP</li>
            <SocialIcon
              url="https://clone-instagramdevmax.netlify.app/"
              fgColor="gray"
              bgColor="transparent"
            />
            <SocialIcon
              url="https://github.com/monthonkachana/clone-instagram"
              fgColor="gray"
              bgColor="transparent"
            />
